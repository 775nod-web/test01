...
グローバルナビゲーションの「調査ケース」からは、全ケースの一覧（簡易版）を確認できます。
フィルターや検索、調査結果の登録機能、取引タイムラインなどを含む本格的な調査ワークベンチと
デモガイド画面はPhase 3で実装します。
...
- 調査ワークベンチの本格的な一覧（フィルター・検索）
- ケース詳細の全セクション（顧客の通常行動比較、取引タイムライン、直近7日間要約、関連情報、監査ログ）
- 調査結果の登録機能（不正/正常/追加確認、メモ、トースト、ステータス更新）
- デモガイド画面
