...
（末尾の show_retail_data_quality_summary()）を書き忘れると、
NameError: name 'product_mismatch_count' is not defined のような
エラーになります。
...
def show_retail_data_quality_summary():
    """sampleスキーマの4表を確認し、データ品質サマリーを表示する。"""
...
show_retail_data_quality_summary()
